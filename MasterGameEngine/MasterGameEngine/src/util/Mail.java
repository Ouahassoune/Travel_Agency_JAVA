...
public class Mail {
    public static void sendMail(String recepient) throws Exception{
        ...
        String myAccountEmail = "easy.make.home@gmail.com";
        String password = "nrjsdqvrmysoekkp";
    ...
    public static Message prepareMessage(Session session, String myAccountEmail, String recepient) {
        ...
        try{
            ...
            String filename = GeneratePdf_Modified.filepath;//change accordingly
